...
func (a *AllTypeTable) Insert(db *sql.DB) error {
	var err error
	...
	result, err := db.Exec(sqlstr, &a.TInt, &a.SInt, &a.MInt, &a.BInt, &a.F32, &a.F64, &a.DecimalMysql, &a.CharM, &a.VarcharM, &a.JSONM, &a.NvarcharM, &a.NcharM, &a.TimeM, &a.DateM, &a.DataTimeM, &a.YearM, &a.TText, &a.MText, &a.TextM, &a.LText, &a.BinaryM, &a.BlobM, &a.LBlob, &a.MBlob, &a.TBlob, &a.BitM, &a.EnumM, &a.SetM, &a.BoolM)
	if err != nil {
		return err
	}
...
func AllTypeTableDelete(db *sql.DB, id uint32) error {
	var err error
...
func AllTypeTableByID(db *sql.DB, id uint32) (*AllTypeTable, error) {
	var err error
	...
	err = db.QueryRow(sqlstr, id).Scan(&a.ID, &a.TInt, &a.SInt, &a.MInt, &a.BInt, &a.F32, &a.F64, &a.DecimalMysql, &a.CharM, &a.VarcharM, &a.JSONM, &a.NvarcharM, &a.NcharM, &a.TimeM, &a.DateM, &a.DataTimeM, &a.TimestampM, &a.TimestampUpdate, &a.YearM, &a.TText, &a.MText, &a.TextM, &a.LText, &a.BinaryM, &a.BlobM, &a.LBlob, &a.MBlob, &a.TBlob, &a.BitM, &a.EnumM, &a.SetM, &a.BoolM)
	if err != nil {
		return nil, err
	}
...
func (a *AllTypeTable) Update(db *sql.DB) error {
	var err error
	...
	_, err = db.Exec(sqlstr, a.TInt, a.SInt, a.MInt, a.BInt, a.F32, a.F64, a.DecimalMysql, a.CharM, a.VarcharM, a.JSONM, a.NvarcharM, a.NcharM, a.TimeM, a.DateM, a.DataTimeM, a.YearM, a.TText, a.MText, a.TextM, a.LText, a.BinaryM, a.BlobM, a.LBlob, a.MBlob, a.TBlob, a.BitM, a.EnumM, a.SetM, a.BoolM, a.ID)
	return err
}

// AllTypeTableByBIntCharM Select by index name:`ix_ccc`
func AllTypeTableByBIntCharM(db *sql.DB, b_int int64, char_m string) (*AllTypeTable, error) {
	...
	err := db.QueryRow(sqlstr, b_int, char_m).Scan(&a.ID, &a.TInt, &a.SInt, &a.MInt, &a.BInt, &a.F32, &a.F64, &a.DecimalMysql, &a.CharM, &a.VarcharM, &a.JSONM, &a.NvarcharM, &a.NcharM, &a.TimeM, &a.DateM, &a.DataTimeM, &a.TimestampM, &a.TimestampUpdate, &a.YearM, &a.TText, &a.MText, &a.TextM, &a.LText, &a.BinaryM, &a.BlobM, &a.LBlob, &a.MBlob, &a.TBlob, &a.BitM, &a.EnumM, &a.SetM, &a.BoolM)
	if err != nil {
		return nil, err
	}
...
func AllTypeTableByMIntVarcharMTimestampM(db *sql.DB, m_int int32, varchar_m string, timestamp_m time.Time) ([]*AllTypeTable, error) {

	const sqlstr = `SELECT ` +
		`id,t_int,s_int,m_int,b_int,f32,f64,decimal_mysql,char_m,varchar_m,json_m,nvarchar_m,nchar_m,time_m,date_m,data_time_m,timestamp_m,timestamp_update,year_m,t_text,m_text,text_m,l_text,binary_m,blob_m,l_blob,m_blob,t_blob,bit_m,enum_m,set_m,bool_m ` +
		`FROM  all_type_table ` +
		`WHERE m_int = ? AND varchar_m = ? AND timestamp_m = ? `
	q, err := db.Query(sqlstr, m_int, varchar_m, timestamp_m)
	if err != nil {
		return nil, err
	}
	defer q.Close()
...
func AllTypeTableByTIntSInt(db *sql.DB, t_int int8, s_int uint16) ([]*AllTypeTable, error) {

	const sqlstr = `SELECT ` +
		`id,t_int,s_int,m_int,b_int,f32,f64,decimal_mysql,char_m,varchar_m,json_m,nvarchar_m,nchar_m,time_m,date_m,data_time_m,timestamp_m,timestamp_update,year_m,t_text,m_text,text_m,l_text,binary_m,blob_m,l_blob,m_blob,t_blob,bit_m,enum_m,set_m,bool_m ` +
		`FROM  all_type_table ` +
		`WHERE t_int = ? AND s_int = ? `
	q, err := db.Query(sqlstr, t_int, s_int)
	if err != nil {
		return nil, err
	}
	defer q.Close()
