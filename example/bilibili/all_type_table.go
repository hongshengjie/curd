...
func (a *AllTypeTable) Insert(ctx context.Context, db *sql.DB) error {
	...
	result, err := db.Exec(ctx, sqlstr, &a.TInt, &a.SInt, &a.MInt, &a.BInt, &a.F32, &a.F64, &a.DecimalMysql, &a.CharM, &a.VarcharM, &a.JSONM, &a.NvarcharM, &a.NcharM, &a.TimeM, &a.DateM, &a.DataTimeM, &a.YearM, &a.TText, &a.MText, &a.TextM, &a.LText, &a.BinaryM, &a.BlobM, &a.LBlob, &a.MBlob, &a.TBlob, &a.BitM, &a.EnumM, &a.SetM, &a.BoolM)
	if err != nil {
		return err
	}
...
func (a *AllTypeTable) Update(ctx context.Context, db *sql.DB) error {
	...
	_, err = db.Exec(ctx, sqlstr, a.TInt, a.SInt, a.MInt, a.BInt, a.F32, a.F64, a.DecimalMysql, a.CharM, a.VarcharM, a.JSONM, a.NvarcharM, a.NcharM, a.TimeM, a.DateM, a.DataTimeM, a.YearM, a.TText, a.MText, a.TextM, a.LText, a.BinaryM, a.BlobM, a.LBlob, a.MBlob, a.TBlob, a.BitM, a.EnumM, a.SetM, a.BoolM, a.ID)
	return err
}
...
func AllTypeTableByMIntVarcharMTimestampM(ctx context.Context, db *sql.DB, m_int int32, varchar_m string, timestamp_m time.Time) ([]*AllTypeTable, error) {
	...
	q, err := db.Query(ctx, sqlstr, m_int, varchar_m, timestamp_m)
	if err != nil {
		return nil, err
	}
	defer q.Close()
...
func AllTypeTableByTIntSInt(ctx context.Context, db *sql.DB, t_int int8, s_int uint16) ([]*AllTypeTable, error) {
	...
	q, err := db.Query(ctx, sqlstr, t_int, s_int)
	if err != nil {
		return nil, err
	}
	defer q.Close()
